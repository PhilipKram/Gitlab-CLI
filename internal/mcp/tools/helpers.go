...
// requireID validates that an ID field is positive and returns an error naming the field.
...
// requireString validates that a string field is non-empty and returns an error naming the field.
