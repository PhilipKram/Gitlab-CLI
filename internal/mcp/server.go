...
import (
	...
	"github.com/PhilipKram/gitlab-cli/internal/mcp/prompts"
	"github.com/PhilipKram/gitlab-cli/internal/mcp/resources"
...
func NewMCPServer(f *cmdutil.Factory) *mcp.Server {
	...
	tools.RegisterTagTools(server, f)
	...
	tools.RegisterPackageTools(server, f)
	tools.RegisterRegistryTools(server, f)
	tools.RegisterProjectTools(server, f)
	tools.RegisterPipelineAnalyticsTools(server, f)
